...
namespace Gamerlizard {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseButtonPressedEvent>(GL_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressedEvent));
		dispatcher.Dispatch<MouseButtonReleasedEvent>(GL_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
		dispatcher.Dispatch<MouseMovedEvent>(GL_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
		...
		dispatcher.Dispatch<KeyTypedEvent>(GL_BIND_EVENT_FN(ImGuiLayer::OnKeyTypedEvent));
